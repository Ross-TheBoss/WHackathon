    ...
    <div className="home-page container py-5">
      <div className="card bg-white shadow p-4">
        ...
        <div className="text-center mb-5">
          <img src="/logo192.png" alt="EventHub logo" className="img-fluid mx-auto d-block" style={{ maxWidth: '150px' }} />
        </div>
        ...
        <section className="about-section text-center mb-5">
          ...
          <br></br>
          <p>
            Welcome to EventHub, your go-to platform for discovering and booking amazing events.
